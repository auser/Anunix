 ...
 *
 * Covers printable ASCII (32-126). Characters outside this range
 * return a filled-block fallback glyph. Each glyph is 16 bytes:
...
/*
 * VGA 8x16 font data for ASCII 32-126 (95 glyphs).
 * Index: (character - 32) * 16
 */
...
const uint8_t *anx_font_glyph(char c)
{
	...
	return &font_data[(uc - 32) * ANX_FONT_HEIGHT];
}
